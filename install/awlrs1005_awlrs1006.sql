...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1005_awlrs1006.sql-arc   1.0   06 Jul 2017 21:26:36   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1005_awlrs1006.sql  $
--       Date into PVCS   : $Date:   06 Jul 2017 21:26:36  $
--       Date fetched Out : $Modtime:   06 Jul 2017 21:10:12  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1005_awlrs1006_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
