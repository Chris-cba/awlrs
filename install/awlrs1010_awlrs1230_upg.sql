...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1230_upg.sql-arc   1.1   Jan 24 2019 11:54:02   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1230_upg.sql  $
--       Date into PVCS   : $Date:   Jan 24 2019 11:54:02  $
--       Date fetched Out : $Modtime:   Jan 24 2019 11:53:48  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1230_1_&log_extension'
define logfile2='awlrs1010_awlrs1230_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1230_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1230_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1230_upg.sql','Upgrade from 1.0.1.0 to 1.2.3.0','1.2.3.0');
END;
/
COMMIT;
SET HEADING OFF
