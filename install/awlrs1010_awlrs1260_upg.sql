...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1260_upg.sql-arc   1.3   Jul 05 2019 14:22:24   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1260_upg.sql  $
--       Date into PVCS   : $Date:   Jul 05 2019 14:22:24  $
--       Date fetched Out : $Modtime:   Jul 05 2019 14:22:02  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1260_1_&log_extension'
define logfile2='awlrs1010_awlrs1260_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'AWLRS'
                          ,p_new_version           => '1.2.6.1'
                          ,p_allowed_old_version_1 => '1.0.1.0'
                          ,p_allowed_old_version_2 => '1.1.8.3'
                          );
END;
/
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1260_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1260_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
