------------------------------------------------------------------
-- awlrs1010_awlrs1240_metadata_upg.sql
------------------------------------------------------------------
...
--  PVCS Identifiers :-
--
--      PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1240_metadata_upg.sql-arc   1.0   Mar 01 2019 14:10:46   Mike.Huitson  $
--      Module Name      : $Workfile:   awlrs1010_awlrs1240_metadata_upg.sql  $
--      Date into PVCS   : $Date:   Mar 01 2019 14:10:46  $
--      Date fetched Out : $Modtime:   Mar 01 2019 13:47:54  $
...
SELECT 'AWLRS_EXTERNAL_LINKS'
 ...
 WHERE NOT EXISTS(SELECT 1
                   ...
                   WHERE HSA_TABLE_NAME = 'AWLRS_EXTERNAL_LINKS'
                     AND HSA_COLUMN_NAME = 'AEL_ID_SEQ')
/
