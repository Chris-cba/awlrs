...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1280_upg.sql-arc   1.0   Sep 06 2019 14:38:20   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1280_upg.sql  $
--       Date into PVCS   : $Date:   Sep 06 2019 14:38:20  $
--       Date fetched Out : $Modtime:   Sep 06 2019 14:37:30  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1280_1_&log_extension'
define logfile2='awlrs1010_awlrs1280_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1280_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1280_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1280_upg.sql','Upgrade 1.2.8.1','1.2.8.1');
END;
/
COMMIT;
SET HEADING OFF
