...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1160.sql-arc   1.0   Jan 29 2019 17:41:26   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1160.sql  $
--       Date into PVCS   : $Date:   Jan 29 2019 17:41:26  $
--       Date fetched Out : $Modtime:   Jan 29 2019 17:11:14  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1160_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
