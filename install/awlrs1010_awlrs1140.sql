...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1140.sql-arc   1.0   Oct 31 2018 15:00:20   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   Oct 31 2018 15:00:20  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1140.sql  $
--       Date fetched Out : $Modtime:   Oct 29 2018 15:12:18  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1140_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
