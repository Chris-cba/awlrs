...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1004_awlrs1005_upg.sql-arc   1.0   15 Jun 2017 19:26:44   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1004_awlrs1005_upg.sql  $
--       Date into PVCS   : $Date:   15 Jun 2017 19:26:44  $
--       Date fetched Out : $Modtime:   15 Jun 2017 19:23:02  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1004_awlrs1005_1_&log_extension'
define logfile2='awlrs1004_awlrs1005_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'AWLRS'
                          ,p_new_version           => '1.0.0.5'
                          ,p_allowed_old_version_1 => '1.0.0.4'
                          );
END;
/
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1004_awlrs1005_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1004_awlrs1005_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1004_awlrs1005_upg.sql','Upgrade from 1.0.0.4 to 1.0.0.5','1.0.0.5');
END;
/
COMMIT;
SET HEADING OFF
