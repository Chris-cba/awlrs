...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1150.sql-arc   1.0   Dec 04 2018 09:54:10   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   Dec 04 2018 09:54:10  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1150.sql  $
--       Date fetched Out : $Modtime:   Dec 03 2018 14:02:22  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1150_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
