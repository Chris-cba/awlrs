...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1290.sql-arc   1.0   Oct 11 2019 14:21:10   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1290.sql  $
--       Date into PVCS   : $Date:   Oct 11 2019 14:21:10  $
--       Date fetched Out : $Modtime:   Oct 11 2019 13:41:38  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1290_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
