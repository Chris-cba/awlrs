...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs13130.sql-arc   1.0   Jun 09 2020 12:08:06   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs13130.sql  $
--       Date into PVCS   : $Date:   Jun 09 2020 12:08:06  $
--       Date fetched Out : $Modtime:   Jun 04 2020 15:37:56  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs13130_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
