...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1180_upg.sql-arc   1.2   Jun 04 2019 11:39:16   Barbara.Odriscoll  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1180_upg.sql  $
--       Date into PVCS   : $Date:   Jun 04 2019 11:39:16  $
--       Date fetched Out : $Modtime:   Jun 04 2019 11:29:48  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1180_1_&log_extension'
define logfile2='awlrs1010_awlrs1180_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1180_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1180_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1180_upg.sql','Upgrade from 1.0.1.0 to 1.1.8.0','1.1.8.2');
END;
/
COMMIT;
SET HEADING OFF
