...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1006_awlrs1007.sql-arc   1.0   Aug 24 2017 11:40:12   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1006_awlrs1007.sql  $
--       Date into PVCS   : $Date:   Aug 24 2017 11:40:12  $
--       Date fetched Out : $Modtime:   Aug 24 2017 10:40:52  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1006_awlrs1007_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
