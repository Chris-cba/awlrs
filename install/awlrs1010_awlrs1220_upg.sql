...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1220_upg.sql-arc   1.5   Oct 18 2018 13:27:54   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1220_upg.sql  $
--       Date into PVCS   : $Date:   Oct 18 2018 13:27:54  $
--       Date fetched Out : $Modtime:   Oct 18 2018 13:12:48  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1220_1_&log_extension'
define logfile2='awlrs1010_awlrs1220_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'AWLRS'
                          ...
                          ,p_allowed_old_version_3 => '1.2.2.1'   
                          );
END;
/
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1220_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1220_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1220_upg.sql','Upgrade from 1.0.1.0 to 1.2.2.0','1.2.2.0');
END;
/
COMMIT;
SET HEADING OFF
