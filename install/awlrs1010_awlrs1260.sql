...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1260.sql-arc   1.0   Jun 06 2019 18:39:28   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1260.sql  $
--       Date into PVCS   : $Date:   Jun 06 2019 18:39:28  $
--       Date fetched Out : $Modtime:   May 23 2019 15:38:18  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1260_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
