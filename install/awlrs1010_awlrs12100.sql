...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs12100.sql-arc   1.0   Nov 26 2019 10:13:40   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs12100.sql  $
--       Date into PVCS   : $Date:   Nov 26 2019 10:13:40  $
--       Date fetched Out : $Modtime:   Nov 06 2019 12:45:08  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs12100_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
