------------------------------------------------------------------
-- awlrs1010_awlrs13170_metadata_upg.sql
------------------------------------------------------------------
...
--  PVCS Identifiers :-
--
--      PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs13170_metadata_upg.sql-arc   1.0   Apr 28 2021 13:33:10   Barbara.Odriscoll  $
--      Module Name      : $Workfile:   awlrs1010_awlrs13170_metadata_upg.sql  $
--      Date into PVCS   : $Date:   Apr 28 2021 13:33:10  $
--      Date fetched Out : $Modtime:   Apr 08 2021 16:52:00  $
...
------------------------------------------------------------------
SET TERM ON
PROMPT Reapply Unit Name changes for LB
SET TERM OFF
UPDATE nm_units
...
------------------------------------------------------------------
SET TERM ON
PROMPT New Error Message for Process Framework
SET TERM OFF
INSERT
  INTO NM_ERRORS
      (NER_APPL
...
------------------------------------------------------------------
SET TERM ON
PROMPT Update to Users Launchpad Metadata
SET TERM OFF
...
INSERT
  INTO HIG_OPTION_LIST
   (HOL_ID, HOL_PRODUCT, HOL_NAME, HOL_REMARKS, HOL_DOMAIN,
    HOL_DATATYPE, HOL_MIXED_CASE, HOL_USER_OPTION, HOL_MAX_LENGTH)
SELECT  'AWLFAVNAME', 'AWLRS', 'Favourites Root Folder', 'The name displayed for the Favourites root folder.', NULL,
    'VARCHAR2', 'Y', 'Y', 100
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_OPTION_LIST
...
------------------------------------------------------------------
SET TERM ON
PROMPT New Error Messages for User Email and Acknowledge Terms of Use
SET TERM OFF
INSERT
  INTO NM_ERRORS
      (NER_APPL
...
------------------------------------------------------------------
SET TERM ON
PROMPT Launchpad metadata for AD Types
SET TERM OFF
INSERT INTO HIG_STANDARD_FAVOURITES
   (HSTF_PARENT, HSTF_CHILD, HSTF_DESCR, HSTF_TYPE, HSTF_ORDER)
SELECT 'AWLRS_NETWORK'
...
INSERT INTO HIG_MODULES
   (HMO_MODULE, HMO_TITLE, HMO_FILENAME, HMO_MODULE_TYPE, HMO_FASTPATH_OPTS, HMO_FASTPATH_INVALID, HMO_USE_GRI, HMO_APPLICATION, HMO_MENU)
SELECT 'AWLRS0002', 'AWLRS Copy Trace', 'awlrs0002', 'FMX', NULL, 
    'Y', 'N', 'AWLRS', NULL
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_MODULES
