...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1008_awlrs1009.sql-arc   1.0   Oct 30 2017 10:45:06   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1008_awlrs1009.sql  $
--       Date into PVCS   : $Date:   Oct 30 2017 10:45:06  $
--       Date fetched Out : $Modtime:   Oct 30 2017 10:16:18  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1008_awlrs1009_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
