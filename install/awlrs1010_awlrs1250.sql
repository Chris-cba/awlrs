...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1250.sql-arc   1.0   Apr 01 2019 14:25:42   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1250.sql  $
--       Date into PVCS   : $Date:   Apr 01 2019 14:25:42  $
--       Date fetched Out : $Modtime:   Apr 01 2019 13:35:32  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1250_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
