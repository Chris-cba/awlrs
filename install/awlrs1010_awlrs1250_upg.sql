...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1250_upg.sql-arc   1.0   Apr 01 2019 14:25:46   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1250_upg.sql  $
--       Date into PVCS   : $Date:   Apr 01 2019 14:25:46  $
--       Date fetched Out : $Modtime:   Apr 01 2019 14:22:54  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1250_1_&log_extension'
define logfile2='awlrs1010_awlrs1250_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1250_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1250_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1250_upg.sql','Upgrade from 1.0.1.0 to 1.2.5.1','1.2.5.1');
END;
/
COMMIT;
SET HEADING OFF
