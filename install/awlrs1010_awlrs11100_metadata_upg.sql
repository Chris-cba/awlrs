------------------------------------------------------------------
-- awlrs1010_awlrs11100_metadata_upg.sql
------------------------------------------------------------------


------------------------------------------------------------------
SET TERM ON
PROMPT Standard Metadata Script Header
SET TERM OFF
-------------------------------------------------------------------------
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs11100_metadata_upg.sql-arc   1.0   May 22 2020 10:25:06   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   May 22 2020 10:25:06  $
--       Module Name      : $Workfile:   awlrs1010_awlrs11100_metadata_upg.sql  $
--       Date fetched Out : $Modtime:   May 22 2020 10:17:44  $
...
------------------------------------------------------------------
SET TERM ON
PROMPT Standard Metadata Script Footer
SET TERM OFF
Commit;
