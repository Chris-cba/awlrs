...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs12130.sql-arc   1.0   May 06 2020 16:45:44   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs12130.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs12130_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
