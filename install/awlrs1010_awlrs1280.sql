...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1280.sql-arc   1.0   Sep 06 2019 14:38:20   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1280.sql  $
--       Date into PVCS   : $Date:   Sep 06 2019 14:38:20  $
--       Date fetched Out : $Modtime:   Aug 21 2019 12:14:56  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1280_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
