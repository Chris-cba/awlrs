...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1230.sql-arc   1.0   Jan 24 2019 11:49:46   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1230.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1230_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
