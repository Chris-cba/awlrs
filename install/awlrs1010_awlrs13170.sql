...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs13170.sql-arc   1.0   Apr 28 2021 13:33:06   Barbara.Odriscoll  $
--       Module Name      : $Workfile:   awlrs1010_awlrs13170.sql  $
--       Date into PVCS   : $Date:   Apr 28 2021 13:33:06  $
--       Date fetched Out : $Modtime:   Jan 25 2021 16:13:52  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs13170_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
