...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1180.sql-arc   1.0   May 22 2019 11:56:28   Barbara.Odriscoll  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1180.sql  $
--       Date into PVCS   : $Date:   May 22 2019 11:56:28  $
--       Date fetched Out : $Modtime:   May 22 2019 10:48:20  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1180_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
