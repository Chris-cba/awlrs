...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1001_awlrs1002_upg.sql-arc   1.0   03 Mar 2017 10:33:58   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1001_awlrs1002_upg.sql  $
--       Date into PVCS   : $Date:   03 Mar 2017 10:33:58  $
--       Date fetched Out : $Modtime:   03 Mar 2017 09:54:58  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1001_awlrs1002_1_&log_extension'
define logfile2='awlrs1001_awlrs1002_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'AWLRS'
                          ,p_new_version           => '1.0.0.2'
                          ,p_allowed_old_version_1 => '1.0.0.1'
                          );
END;
/
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1001_awlrs1002_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1001_awlrs1002_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1001_awlrs1002_upg.sql','Upgrade from 1.0.0.1 to 1.0.0.2','1.0.0.2');
END;
/
COMMIT;
SET HEADING OFF
