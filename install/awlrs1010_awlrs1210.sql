...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1210.sql-arc   1.0   Sep 19 2018 11:52:14   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1210.sql  $
--       Date into PVCS   : $Date:   Sep 19 2018 11:52:14  $
--       Date fetched Out : $Modtime:   Sep 14 2018 12:31:04  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1210_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
