------------------------------------------------------------------
-- awlrs1010_awlrs11100_ddl_upg.sql
------------------------------------------------------------------


------------------------------------------------------------------
SET TERM ON
PROMPT Standard DDL Script Header
SET TERM OFF
-------------------------------------------------------------------------
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs11100_ddl_upg.sql-arc   1.0   May 22 2020 10:25:04   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   May 22 2020 10:25:04  $
--       Module Name      : $Workfile:   awlrs1010_awlrs11100_ddl_upg.sql  $
--       Date fetched Out : $Modtime:   May 22 2020 10:17:16  $
