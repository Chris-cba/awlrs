...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs13150.sql-arc   1.0   Jul 23 2020 15:52:38   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs13150.sql  $
--       Date into PVCS   : $Date:   Jul 23 2020 15:52:38  $
--       Date fetched Out : $Modtime:   Jul 23 2020 12:02:12  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs13150_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
