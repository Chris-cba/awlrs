...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1170.sql-arc   1.0   Apr 08 2019 13:44:44   Barbara.Odriscoll  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1170.sql  $
--       Date into PVCS   : $Date:   Apr 08 2019 13:44:44  $
--       Date fetched Out : $Modtime:   Apr 08 2019 11:31:28  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1170_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
