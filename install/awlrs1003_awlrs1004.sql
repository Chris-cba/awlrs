...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1003_awlrs1004.sql-arc   1.0   04 May 2017 13:56:14   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1003_awlrs1004.sql  $
--       Date into PVCS   : $Date:   04 May 2017 13:56:14  $
--       Date fetched Out : $Modtime:   04 May 2017 12:02:14  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1003_awlrs1004_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
