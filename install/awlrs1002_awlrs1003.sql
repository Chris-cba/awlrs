...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1002_awlrs1003.sql-arc   1.0   08 Mar 2017 16:18:52   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1002_awlrs1003.sql  $
--       Date into PVCS   : $Date:   08 Mar 2017 16:18:52  $
--       Date fetched Out : $Modtime:   08 Mar 2017 16:13:28  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1002_awlrs1003_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
