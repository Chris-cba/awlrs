...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1007_awlrs1008.sql-arc   1.0   Oct 06 2017 09:30:20   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1007_awlrs1008.sql  $
--       Date into PVCS   : $Date:   Oct 06 2017 09:30:20  $
--       Date fetched Out : $Modtime:   Oct 06 2017 08:57:54  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1007_awlrs1008_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
