...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1220.sql-arc   1.0   Oct 10 2018 19:40:36   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1220.sql  $
--       Date into PVCS   : $Date:   Oct 10 2018 19:40:36  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1220_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
