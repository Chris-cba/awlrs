...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs11100.sql-arc   1.0   May 22 2020 10:25:04   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   May 22 2020 10:25:04  $
--       Module Name      : $Workfile:   awlrs1010_awlrs11100.sql  $
--       Date fetched Out : $Modtime:   May 22 2020 10:16:30  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs11100_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
