...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1240.sql-arc   1.0   Mar 01 2019 14:10:44   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1240.sql  $
--       Date into PVCS   : $Date:   Mar 01 2019 14:10:44  $
--       Date fetched Out : $Modtime:   Jan 21 2019 20:23:42  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1240_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
