...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs12160_upg.sql-arc   1.1   Nov 16 2020 10:36:16   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   Nov 16 2020 10:36:16  $
--       Module Name      : $Workfile:   awlrs1010_awlrs12160_upg.sql  $
--       Date fetched Out : $Modtime:   Nov 16 2020 10:31:32  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs12160_1_&log_extension'
define logfile2='awlrs1010_awlrs12160_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs12160_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs12160_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs12160_upg.sql','Upgrade to 1.2.16.1','1.2.16.1');
END;
/
COMMIT;
SET HEADING OFF
