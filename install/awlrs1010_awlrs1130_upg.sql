...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1130_upg.sql-arc   1.0   Sep 19 2018 11:51:36   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1130_upg.sql  $
--       Date into PVCS   : $Date:   Sep 19 2018 11:51:36  $
--       Date fetched Out : $Modtime:   Sep 17 2018 18:13:10  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1130_1_&log_extension'
define logfile2='awlrs1010_awlrs1130_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1130_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1130_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1130_upg.sql','Upgrade from 1.0.1.0 to 1.1.3.0','1.1.3.1');
END;
/
COMMIT;
SET HEADING OFF
