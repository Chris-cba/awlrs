...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs12170.sql-arc   1.0   Jan 25 2021 18:41:34   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1010_awlrs12170.sql  $
--       Date into PVCS   : $Date:   Jan 25 2021 18:41:34  $
--       Date fetched Out : $Modtime:   Jan 25 2021 16:18:12  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs12170_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
