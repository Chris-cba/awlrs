...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs13140.sql-arc   1.0   Jul 06 2020 08:38:46   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs13140.sql  $
--       Date into PVCS   : $Date:   Jul 06 2020 08:38:46  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs13140_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
