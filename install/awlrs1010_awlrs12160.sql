...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs12160.sql-arc   1.0   Nov 10 2020 13:33:24   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   Nov 10 2020 13:33:24  $
--       Module Name      : $Workfile:   awlrs1010_awlrs12160.sql  $
--       Date fetched Out : $Modtime:   Nov 10 2020 11:58:28  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs12160_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
