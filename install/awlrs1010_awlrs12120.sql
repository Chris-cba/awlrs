...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs12120.sql-arc   1.0   Mar 18 2020 15:55:02   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs12120.sql  $
--       Date into PVCS   : $Date:   Mar 18 2020 15:55:02  $
--       Date fetched Out : $Modtime:   Mar 10 2020 10:10:38  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs12120_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
