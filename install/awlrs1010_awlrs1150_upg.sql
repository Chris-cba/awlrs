...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1150_upg.sql-arc   1.0   Dec 04 2018 09:54:16   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   Dec 04 2018 09:54:16  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1150_upg.sql  $
--       Date fetched Out : $Modtime:   Dec 03 2018 14:05:18  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1150_1_&log_extension'
define logfile2='awlrs1010_awlrs1150_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'AWLRS'
                          ,p_new_version           => '1.1.5.0'
                          ,p_allowed_old_version_1 => '1.0.1.0'
                          ,p_allowed_old_version_2 => '1.1.4.2'
                          );
END;
/
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1150_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1150_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1150_upg.sql','Upgrade from 1.0.1.0 to 1.1.5.0','1.1.5.1');
END;
/
COMMIT;
SET HEADING OFF
