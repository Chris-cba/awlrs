...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1004_awlrs1005.sql-arc   1.0   15 Jun 2017 19:26:36   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1004_awlrs1005.sql  $
--       Date into PVCS   : $Date:   15 Jun 2017 19:26:36  $
--       Date fetched Out : $Modtime:   15 Jun 2017 19:12:28  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1004_awlrs1005_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
