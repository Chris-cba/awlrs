...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs12140_upg.sql-arc   1.0   Jul 06 2020 08:38:44   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs12140_upg.sql  $
--       Date into PVCS   : $Date:   Jul 06 2020 08:38:44  $
--       Date fetched Out : $Modtime:   Jun 11 2020 10:47:04  $
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs12140_upg.sql','Upgrade from 1.0.1.0 to 1.2.14.0','1.2.14.0');
END;
/
COMMIT;
SET HEADING OFF
