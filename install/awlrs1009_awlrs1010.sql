...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1009_awlrs1010.sql-arc   1.0   Mar 08 2018 17:49:04   Mike.Huitson  $
--       Module Name      : $Workfile:   awlrs1009_awlrs1010.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1009_awlrs1010_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
