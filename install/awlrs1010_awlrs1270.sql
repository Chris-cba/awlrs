...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1270.sql-arc   1.0   Jul 24 2019 15:45:28   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1270.sql  $
--       Date into PVCS   : $Date:   Jul 24 2019 15:45:28  $
--       Date fetched Out : $Modtime:   Jul 24 2019 15:07:36  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1270_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
