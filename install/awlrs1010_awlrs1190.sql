...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1190.sql-arc   1.0   Oct 21 2019 10:18:04   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   Oct 21 2019 10:18:04  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1190.sql  $
--       Date fetched Out : $Modtime:   Oct 21 2019 10:02:02  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'awlrs'||'&terminator'||
        'install'||'&terminator'||'awlrs1010_awlrs1190_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
