...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs1010_awlrs1270_upg.sql-arc   1.1   Aug 06 2019 10:54:28   Peter.Bibby  $
--       Module Name      : $Workfile:   awlrs1010_awlrs1270_upg.sql  $
--       Date into PVCS   : $Date:   Aug 06 2019 10:54:28  $
--       Date fetched Out : $Modtime:   Aug 06 2019 09:05:44  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='awlrs1010_awlrs1270_1_&log_extension'
define logfile2='awlrs1010_awlrs1270_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1270_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'awlrs'||'&terminator'||'install'||
        '&terminator'||'awlrs1010_awlrs1270_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('AWLRS','awlrs1010_awlrs1270_upg.sql','Upgrade to 1.2.7.1','1.2.7.1');
END;
/
COMMIT;
SET HEADING OFF
