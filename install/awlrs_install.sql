...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs_install.sql-arc   1.34   May 22 2019 11:42:00   Barbara.Odriscoll  $
--       Module Name      : $Workfile:   awlrs_install.sql  $
--       Date into PVCS   : $Date:   May 22 2019 11:42:00  $
--       Date fetched Out : $Modtime:   May 22 2019 11:29:24  $
...
SET TERM OFF
BEGIN
  hig2.upgrade('AWLRS','awlrs_install.sql','Installed','1.1.8.1');
END;
/
COMMIT;
--
