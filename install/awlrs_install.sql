...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/awlrs/install/awlrs_install.sql-arc   1.18   Jul 12 2018 15:01:02   Barbara.Odriscoll  $
--       Module Name      : $Workfile:   awlrs_install.sql  $
--       Date into PVCS   : $Date:   Jul 12 2018 15:01:02  $
--       Date fetched Out : $Modtime:   Jul 12 2018 15:00:02  $
...
SET TERM OFF
BEGIN
  hig2.upgrade('AWLRS','awlrs_install.sql','Installed','1.1.1.1');
END;
/
COMMIT;
--
